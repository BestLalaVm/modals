...
class alipayment
{
    public function generateDirectForm(paymentmodel $model)
    {
        ...
        $conf = new alipayConfig($model->paymentNotifyUrl,$model->paymentReturnUrl);
        $configValue = $conf->alipay_config;
        $configValue["notify_url"] = $model->paymentNotifyUrl;
        $configValue["return_url"] = $model->paymentReturnUrl;
        $parameter = array(
    ...
    public function executeReturnUrl($notifyUrl,$returnUrl,$successCallBack,$failedCallBack)
    {
        require_once(APPPATH."third_party/alipaymd5direct/lib/alipay_notify.class.php");
        $conf = new alipayConfig($notifyUrl,$returnUrl);
        $configValue = $conf->alipay_config;
    ...
    public function executeNotify($notifyUrl,$returnUrl,$successCallBack,$failedCallBack){
        require_once(APPPATH."third_party/alipaymd5direct/lib/alipay_notify.class.php");
