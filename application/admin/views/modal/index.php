...
?>
<?php echo form_open(site_url("modal/index"),array("method"=>"get","id"=>"frmSearch")); ?>
...
<div class="row-fluid">
    <div class="span1">
        <a class="btn blue" href="<?= site_url("modal/create") ?>">新增</a>
    </div>
    <div class="span9"></div>
    ...
    <table class="table table-striped table-hover table-bordered dataTable" id="sample_editable_1"
        ...
        <?php foreach ($datas as $item): ?>
            <tr class="<?= ($index % 2 == 0) ? "even" : "odd" ?>">
                ...
                <td class=" "><a class="edit" href="<?= site_url("modal/edit/") . $item->id ?>">编辑</a></td>
                <td class=" "><a class="delete" href="#" data-url="<?= site_url("modal/delete/") . $item->id ?>">删除</a></td>
            </tr>
        <?php endforeach; ?>
        </tbody>
    </table>
