<?php
 ...
 ?>
 <div>
   <a class="btn blue" href="<?=site_url("modaltag/create")?>">新增</a>
 </div>
    ...
    <table class="table table-striped table-hover table-bordered dataTable" id="sample_editable_1" aria-describedby="sample_editable_1_info"> 
     ...
     <?php foreach($list as $item):?>
      <tr class="<?=($index%2==0)?"even":"odd" ?>"> 
       ...
       <td class=" "><a class="edit" href="<?=site_url("modaltag/edit/").$item->id ?>">编辑</a></td>
       <td class=" "><a class="delete" href="#" data-url="<?=site_url("modaltag/delete/").$item->id?>">删除</a></td>
      </tr>
      <?php endforeach;?>    
     </tbody>
    </table>
